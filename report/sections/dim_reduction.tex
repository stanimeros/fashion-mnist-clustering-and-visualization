...
\begin{description}
  ...
  \item[PCA] Linear projection retaining 95\% of variance ($\approx$85 components).
  \item[SAE] Stacked Autoencoder with a 32-D bottleneck (fully connected layers).
  \item[CNN-SAE] Convolutional Stacked Autoencoder; captures translation-invariant features.
  \item[t-SNE] Non-linear 2-D embedding preserving local neighbourhoods.
  \item[UMAP] Non-linear 2-D embedding preserving both local and global structure.
\end{description}
