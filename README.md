...
**Python:** **3.10 ή νεότερο** (το `requirements.txt` είναι καρφιτσωμένο ώστε να μην απαιτείται 3.11· παλιότερα pins χρησιμοποιούσαν πακέτα που θέλουν μόνο `>=3.11`). Το `keras` ως ξεχωριστό πακέτο δεν χρειάζεται — χρησιμοποιείται `tensorflow.keras`.
